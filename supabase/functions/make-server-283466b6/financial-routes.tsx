...
function errorResponse(c: any, context: string, error: unknown) {
  ...
  console.log(`[Financial] ${context} (${status}): ${msg}`);
...
financial.get(`${PREFIX}/dashboard/financial/metrics`, async (c) => {
  try {
    ...
    const [invRes, payRes] = await Promise.all([
      db.from("dashboard_invoices").select("*").eq("user_id", userId),
      db.from("dashboard_payments").select("*").eq("user_id", userId),
    ]);
...
financial.get(`${PREFIX}/dashboard/financial/invoices`, async (c) => {
  try {
    ...
    return errorResponse(c, "Failed to list invoices", err);
  }
});
...
financial.post(`${PREFIX}/dashboard/financial/invoices`, async (c) => {
  try {
    ...
    return errorResponse(c, "Failed to create invoice", err);
  }
});
...
financial.put(`${PREFIX}/dashboard/financial/invoices/:id`, async (c) => {
  try {
    ...
    return errorResponse(c, "Failed to update invoice", err);
  }
});
...
financial.delete(`${PREFIX}/dashboard/financial/invoices/:id`, async (c) => {
  try {
    ...
    const { error } = await db.from("dashboard_invoices").delete().eq("id", invoiceId).eq("user_id", userId);
    ...
    return errorResponse(c, "Failed to delete invoice", err);
  }
});
...
financial.post(`${PREFIX}/dashboard/financial/payments/record`, async (c) => {
  try {
    ...
    return errorResponse(c, "Failed to record payment", err);
  }
});
...
financial.get(`${PREFIX}/dashboard/financial/payments`, async (c) => {
  try {
    ...
    return errorResponse(c, "Failed to list payments", err);
  }
});
...
financial.get(`${PREFIX}/dashboard/financial/charts`, async (c) => {
  try {
    ...
    return errorResponse(c, "Failed to get chart data", err);
  }
});
...
financial.get(`${PREFIX}/dashboard/financial/profitability`, async (c) => {
  try {
    ...
    return errorResponse(c, "Failed to get profitability", err);
  }
});
...
financial.post(`${PREFIX}/dashboard/financial/invoices/:id/reminder`, async (c) => {
  try {
    ...
    return errorResponse(c, "Failed to send reminder", err);
  }
});
