...
-- RLS: edge function uses service role (bypasses RLS). Permissive policies for anon/authenticated if called via client.
create policy "workflows_select" on public.workflows for select to authenticated, anon using (true);
create policy "workflows_insert" on public.workflows for insert to authenticated, anon with check (true);
create policy "workflows_update" on public.workflows for update to authenticated, anon using (true) with check (true);
create policy "workflows_delete" on public.workflows for delete to authenticated, anon using (true);
...
create policy "workflow_executions_select" on public.workflow_executions for select to authenticated, anon using (true);
create policy "workflow_executions_insert" on public.workflow_executions for insert to authenticated, anon with check (true);
...
create policy "dashboard_invoices_select" on public.dashboard_invoices for select to authenticated, anon using (true);
create policy "dashboard_invoices_insert" on public.dashboard_invoices for insert to authenticated, anon with check (true);
create policy "dashboard_invoices_update" on public.dashboard_invoices for update to authenticated, anon using (true) with check (true);
create policy "dashboard_invoices_delete" on public.dashboard_invoices for delete to authenticated, anon using (true);
...
create policy "dashboard_payments_select" on public.dashboard_payments for select to authenticated, anon using (true);
create policy "dashboard_payments_insert" on public.dashboard_payments for insert to authenticated, anon with check (true);
