      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-6xl xl:text-7xl mb-8 text-[#FAF9F5] leading-tight"
            ...
            Build an AI Web App That Works While You Sleep
          </h2>

          {/* Body */}
          <p className="text-xl lg:text-2xl text-[#FAF9F5]/70 mb-12 leading-relaxed max-w-2xl mx-auto"
             style={{ fontFamily: 'system-ui, -apple-system' }}>
            Replace manual processes with intelligent systems designed to scale. Start with strategy, ship with confidence.
          </p>
          ...
          <motion.p
            ...
            style={{ fontFamily: 'system-ui, -apple-system' }}
          >
            Clear scope. Modern stack. Delivered in 6–8 weeks.
          </motion.p>
        </motion.div>
      </div>
    </section>
