    ...
    <section className="relative bg-[#0F3D3E] py-32 md:py-40 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <button
            className="bg-[#84CC16] hover:bg-[#73b512] text-gray-900 px-8 py-4 text-base font-semibold transition-colors duration-200 min-w-[280px] flex items-center justify-center gap-2 mx-auto font-['Lora']"
